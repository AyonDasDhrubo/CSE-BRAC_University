...
%token IF ELSE FOR ID LPAREN RPAREN COMMA LCURL RCURL SEMICOLON INT FLOAT VOID LTHIRD RTHIRD CONST_INT CONST_FLOAT DEFAULT
       WHILE PRINTLN RETURN ASSIGNOP LOGICOP RELOP ADDOP MULOP NOT INCOP DECOP DO BREAK CONTINUE CHAR DOUBLE SWITCH CASE
%nonassoc ELSE
%%
...
program : program unit
	...
	| simple_expression ADDOP term
	{
		...
		$$ = new symbol_info($1->getname() + "+" + $3->getname(), "simple_expression");
	}
	;
